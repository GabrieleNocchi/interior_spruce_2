...
Enviro_Vars<-read.table ("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/Quer_pet_list.tsv")
...
for(qqq in 1:(nrow(Enviro_Vars))){
  ...
  setwd("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq")
  pval <- read.table ((paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_pval.tsv"),collapse="")))
  names1 <- read.table ((paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_gene_names2.tsv"),collapse="")))
  
  
  ld_chroms <- sapply (strsplit(as.character (names1[,1]),split = "__"),"[[",1)
  ld_pos <- as.numeric (names1[,2])
  
#only does thing with windowsize in position 3 of vector. shrink window size to something smaller like 1 , 2, or 5 for your smaller chromosomes I suspect.
  ...
  #max state of HMM considered. I suggest running a single run, look at the BIC in the crits and adjusting this to be a couple/few higher than BIC min state number.
  max_states <- 14
...
#sd in 1:2 will do seeds 1001 and 1002. Adjust to be a single seed by doing 1:1 or more seeds to 1:100 example.
 for(sd in 1:2){ 
  #---------- HMM Time------------------
  
  Mix_mod_List<-vector("list", (length(max_states)))
  Fit_Mix_mod_List<-vector("list", (length(max_states)))
  #runs 3 state model to max_state model
  for (pp in 3:max_states){
    set.seed((1000+sd))
...
#  for(i in 1:length(which_chroms)){
 ...
 # testing_statenums<-sort(unique(c(optimal_statenums,optimal_statenums_rev)),decreasing=FALSE)
  testing_statenums2<-c(3,max_states)
  #testing_statenums2
...
#  optimal_statenums_store<-optimal_statenums-testing_statenums2[1]+1
 ...
 # I_window_optimal_StatTable_reorder<-I_window_optimal_StatTable[c(1),]
  ...
  saveRDS(Allwindow_stat_List, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_Allwindow_stat_List_Streamline_seed_",(1000+sd),".rds"),collapse=""))
 # saveRDS(I_windows_results, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_Streamline.rds"),collapse=""))
 # saveRDS(I_windows_results_3, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_3.rds"),collapse=""))
#  saveRDS(I_windows_results_phybrid, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_phybrid.rds"),collapse=""))
#  saveRDS(I_windows_results_phybrid3, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_phybrid3.rds"),collapse=""))
  #saveRDS(I_windows_results_phybridnonneg, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_phybridnonneg.rds"),collapse=""))
  #saveRDS(I_windows_results_phybridnonneg3, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_phybridnonneg3.rds"),collapse=""))
  #saveRDS(I_windows_results_5, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_windows_results_5.rds"),collapse=""))
  
#  saveRDS(optimal_statenums, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_optimal_statenums_Streamline.rds"),collapse=""))
#  saveRDS(optimal_statenums_rev, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_optimal_statenums_rev_Streamline.rds"),collapse=""))
  saveRDS(testing_statenums2, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_testing_statenums2_Streamline_seed_",(1000+sd),".rds"),collapse=""))
  
  saveRDS(the_crits_list, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_the_crits_list_Streamline_seed_",(1000+sd),".rds"),collapse=""))
#  saveRDS(the_crits_list_rev, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_the_crits_list_rev_Streamline.rds"),collapse=""))

  
 # write.csv(I_window_optimal_StatTable, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_window_optimal_StatTable_Streamline.csv"),collapse=""), row.names=FALSE)
 # write.csv(I_window_optimal_StatTable_reorder, paste(c("/data/michael_HMM/HMM_SNPfiles/New_folder/220927_Quercus_petraea_Kremer_PoolSeq/",Enviro_Vars_of_Interest,"_ReOrder_window_",window_sizes[3],"_I_window_optimal_StatTable_reorder_Streamline.csv"),collapse=""), row.names=FALSE)
