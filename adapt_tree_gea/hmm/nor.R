...
my_results <- readRDS("likelihood_ratio_results_4.Norquay.rds")
...
testing_statenums2<-c(min_states,max_states)
 ...
 saveRDS(Allwindow_stat_List, paste(c("4.Norquay_ReOrder_window_",window_size,"_window_stats_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(testing_statenums2, paste(c("4.Norquay_ReOrder_window_",window_size,"_state_number_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(the_crits_list, paste(c("4.Norquay_ReOrder_window_",window_size,"_the_crits_list__seed_",(1000+sd),".rds"),collapse=""))
