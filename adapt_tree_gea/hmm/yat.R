...
my_results <- readRDS("likelihood_ratio_results_7.Yates.rds")
...
for(sd in 1:10){
 ...
 saveRDS(Allwindow_stat_List, paste(c("7.Yates_ReOrder_window_",window_size,"_window_stats_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(testing_statenums2, paste(c("7.Yates_ReOrder_window_",window_size,"_state_number_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(the_crits_list, paste(c("7.Yates_ReOrder_window_",window_size,"_the_crits_list__seed_",(1000+sd),".rds"),collapse=""))
