...
my_results <- readRDS("likelihood_ratio_results_2.Cathedral.rds")
...
testing_statenums2<-c(min_states,max_states)
 ...
 saveRDS(Allwindow_stat_List, paste(c("2.Cathedral_ReOrder_window_",window_size,"_window_stats_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(testing_statenums2, paste(c("2.Cathedral_ReOrder_window_",window_size,"_state_number_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(the_crits_list, paste(c("2.Cathedral_ReOrder_window_",window_size,"_the_crits_list__seed_",(1000+sd),".rds"),collapse=""))
