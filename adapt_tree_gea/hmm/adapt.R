...
my_results <- readRDS("adapt_tree_likelihood_ratio_results_PC1.rds")
...
testing_statenums2<-c(min_states,max_states)
 ...
 saveRDS(Allwindow_stat_List, paste(c("adapt_tree_PC1_ReOrder_window_",window_size,"_window_stats_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(testing_statenums2, paste(c("adapt_tree_PC1_ReOrder_window_",window_size,"_state_number_seed_",(1000+sd),".rds"),collapse=""))

 saveRDS(the_crits_list, paste(c("adapt_tree_PC1_ReOrder_window_",window_size,"_the_crits_list__seed_",(1000+sd),".rds"),collapse=""))
